  ...
  return (
    <Suspense fallback={
      <div className="login-root" suppressHydrationWarning>
        <div className="login-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '350px' }} suppressHydrationWarning>
          <div className="login-logo" style={{ marginBottom: '1.5rem' }} suppressHydrationWarning>
      ...
      <div className="login-card" suppressHydrationWarning>
        ...
        <div className="login-brand">
          ...
          <h1 className="login-title">
            {isSignUp ? 'Create Account' : 'StadiumSetu'}
          </h1>
          <p className="login-subtitle">
            {isSignUp ? 'Register a new account to join the fan zone.' : 'Sign in to continue to StadiumSetu.'}
          </p>
        </div>
          ...
          >
            {loading ? (
              <span className="btn-spinner" aria-label={isSignUp ? 'Signing up…' : 'Signing in…'}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="spinner-icon" style={{ animation: 'spin 1s linear infinite' }}>
